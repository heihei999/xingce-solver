# Project Regression Summary After Verbal Reasoning MCP Guidance
...
- get_verbal_reasoning_scaffold added to MCP guidance preview
- MCP guidance smoke report updated for verbal reasoning
- MCP guidance preview now contains 6 read-only scaffold tools
...
- six guidance tools are read-only
