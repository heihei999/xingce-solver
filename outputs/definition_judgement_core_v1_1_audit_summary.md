...
- A: violates matched=[] missing=['object', 'method', 'method', 'action', 'action', 'attribute'] violated=[] score=0.00
- B: violates matched=[] missing=['object', 'method', 'method', 'action', 'action', 'attribute'] violated=[] score=0.00
- C: violates matched=[] missing=['object', 'method', 'method', 'action', 'action', 'attribute'] violated=[] score=0.00
- D: violates matched=[] missing=['object', 'method', 'method', 'action', 'action', 'attribute'] violated=[] score=0.00
...
- A: matches matched=['keyword'] missing=[] violated=[] score=0.20
- B: matches matched=['keyword'] missing=[] violated=[] score=0.20
- C: matches matched=['keyword'] missing=[] violated=[] score=0.20
- D: unknown matched=[] missing=[] violated=[] score=0.00
