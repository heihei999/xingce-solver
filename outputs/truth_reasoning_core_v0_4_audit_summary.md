# Truth Reasoning Core v0.4 — Option Mapping Audit Summary
...
| case_id | expected | status | option_status | predicted | correct |
|---|---|---|---|---|---|
| LTRUTH-REAL-001 | A | ambiguous | no_supported_option | - | - |
| LTRUTH-REAL-002 | A | solved | no_supported_option | - | - |
| LTRUTH-REAL-003 | D | ambiguous | no_supported_option | - | - |
| LTRUTH-REAL-004 | D | ambiguous | no_supported_option | - | - |
| LTRUTH-REAL-005 | C | solved | unique_supported | C | Y |
| LTRUTH-REAL-006 | C | ambiguous | no_supported_option | - | - |
| LTRUTH-REAL-007 | A | ambiguous | no_supported_option | - | - |
| LTRUTH-REAL-008 | C | ambiguous | no_supported_option | - | - |
| LTRUTH-REAL-009 | A | solved | no_supported_option | - | - |
| LTRUTH-REAL-010 | B | ambiguous | no_supported_option | - | - |
| LTRUTH-REAL-011 | B | solved | no_supported_option | - | - |
| LTRUTH-REAL-012 | C | ambiguous | no_supported_option | - | - |
...
### LTRUTH-REAL-002 (status=solved, option_status=no_supported_option)
- A: unknown [?] 左手是水果糖，右手是奶糖
...
### LTRUTH-REAL-011 (status=solved, option_status=no_supported_option)
