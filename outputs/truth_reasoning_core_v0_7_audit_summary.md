...
| LTRUTH-REAL-009 | A | solved | unique_supported | A | Y | 0 |
...
### LTRUTH-REAL-009 (status=solved, option_status=unique_supported)
- A: entailed_by_all [T] 去了四姑娘山、塔公草原、墨石公园
...
- LTRUTH-REAL-009: predicted=A, expected=A, correct=True
